...
def generate_launch_description():
    ...
    pipeline_nodes = [
        ...
        # Fuses the gate poles with the symbol detections for the front pose,
        # replacing the plain front estimator above. auv5 only -- the auv4 gate
        # config has no symbol model to feed it.
        Node(
            package="pose_estimator",
